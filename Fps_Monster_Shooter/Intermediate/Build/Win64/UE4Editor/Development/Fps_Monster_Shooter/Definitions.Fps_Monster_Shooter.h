...
#define UE_PROJECT_NAME Fps_Monster_Shooter
#define UE_TARGET_NAME Fps_Monster_ShooterEditor
#define UE_MODULE_NAME "Fps_Monster_Shooter"
...
#define FPS_MONSTER_SHOOTER_API DLLEXPORT
